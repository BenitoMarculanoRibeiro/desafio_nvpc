...
my_dates = [{'name': 'zag-horario', 'url': 'https://github.com/BenitoMarculanoRibeiro/ag-horario', 'archived': True, 'language': 'Java', 'fork': False, 'created_at': '2019-10-24T23:38:59Z', 'updated_at': '2022-05-05T19:55:54Z', 'pushed_at': '2019-10-25T00:04:58Z'},
            {'name': 'f-LM', 'url': 'https://github.com/BenitoMarculanoRibeiro/AG-LM', 'archived': True, 'language': 'PHP', 'fork': False, 'created_at': '2020-08-06T16:29:52Z', 'updated_at': '2022-05-05T19:55:05Z', 'pushed_at': '2020-08-28T11:05:30Z'}]

my_dates.sort(key=lambda date: datetime.strptime(date['updated_at'], "%Y-%m-%dT%H:%M:%SZ"),reverse=True)
print(my_dates)
for i in my_dates:
